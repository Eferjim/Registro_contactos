    ...
    <main>
        ...
        <table class="table table-hover" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td style="text-align: center"><a href="{{route('empresa.editar', $empresa->id)}}"><button style="color:white;" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mx-auto">
                <a href="{{route('empresa.crearEmpresa')}}" class="btn btn-lg btn-primary" style="background-color: #08acb4">Nueva Empresa</a>
